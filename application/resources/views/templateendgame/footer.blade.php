    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-lg-3">
                ...
                <p class="mt-3 ml-2" style="color: white; font-size: 14px;"> Sebagai Pusat Toko Online di
                    Palembang, kami
        ...
        <div class="row">
            <div class="col">
                <p class="copyright ml-1" style="color: white;">Copyright<img src="{{ asset('asset/503013.png') }}"
