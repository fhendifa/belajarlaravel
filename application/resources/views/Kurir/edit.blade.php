                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ url('/kurir/' . $kurir->id) }}" method="POST"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama"
                                            ...
                                            value="{{ $kurir->nama_kurir }}" placeholder="Enter Nama Kurir">
                                        @error('nama')
