                    ...
                    <div class="col">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="text-right "><a href="{{ url('/kurir/create') }}" role="button"
                                        class="btn btn-success"><i class="fas fa-plus">Add Kurir</i></a></div>
                            </div>
                            <div class="card-body">
                                <!-- /.card-header -->
                                        ...
                                        <tbody>
                                            @foreach ($kurir as $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $item->ongkir }}</td>
                                                    <td><a href="{{ url('/kurir/' . $item->id . '/edit') }}"
                                                            role="button" class="btn btn-success"><i
                                                                class="fas fa-edit">Edit</i></a>
                                                        <form action="{{ url('/kurir/' . $item->id) }}" method="POST"
