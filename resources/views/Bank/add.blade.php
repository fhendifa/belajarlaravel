                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Add <strong>Bank</strong></h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="rek"
                                            ...
                                            value="{{ old('rek') }}" placeholder="Enter No Rekening">
                                        @error('rek')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama"
                                            ...
                                            value="{{ old('nama') }}" placeholder="Enter Name Bank">
                                        @error('nama')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
